  ...
  static final router = GoRouter(
    routes: [
      ...
      GoRoute(
        ...
        builder: (context, state) => BlocProvider(
          create: (context) {
            var startPage = state.pathParameters['id1'] as String;
            var endPage = state.pathParameters['id2'] as String;
            return AgzaaCubit()
              ..fetchJuzhPages(
                  start: int.parse(startPage), end: int.parse(endPage));
          },
          child: JuzhView(
            startPage: state.pathParameters['id1'] as String,
      ...
      GoRoute(
        ...
        builder: (context, state) => SadaqaSurahView(
            name: state.pathParameters['id1'] as String,
            pageNumber: state.pathParameters['id2'] as String),
      ),
      GoRoute(
        ...
        builder: (context, state) => TasbihViewItem(
          name: state.pathParameters['id1'] as String,
          counter: int.parse('${state.pathParameters['id2']}') as int,
        ),
      ),
      // GoRoute(
